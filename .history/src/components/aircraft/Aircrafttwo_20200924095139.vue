      ...
      <div class="box">
        ...
        <div>
          <div v-for="(item,index) in aviation" :key="index">
            <div class="gob">
              <div  style="margin-left:10px ;" class="bbc">{{item.airline_name}}&nbsp;{{item.flight_no}}</div>
            <div style="margin-left:30px ;" class="bbc" id="nkjada">
                <div class="cnn">
              ...
              <div class="lkpkl"></div>
              <div  class="bbc" style="padding-rigth:30px ;">
                <div class="cnn">
