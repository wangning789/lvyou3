      ...
      <div class="box">
        ...
        <div>
          <div v-for="(item,index) in aviation" :key="index">
            <div class="gob">
              <div style="font-size:15px;color: black;" class="bbc">{{item.airline_name}}&nbsp;{{item.flight_no}}</div>
            <div  class="bbc" id="nkjada">
                <div class="cnn">
                <div style="font-size:22px;color: black;">{{item.dep_time}}</div>
              ...
              <div  class="bbc">
                <div class="cnn">
                <div style="font-size:22px;color: black;">{{item.arr_time}}</div>
                <div>{{item.dst_airport_name}}{{item.dst_airport_quay}}</div>
              </div>
              </div>
              <div  class="bbc">
                <div>￥<label class="dkoasda">{{item.base_price}}</label>起</div>
              </div>
            </div>
          </div>
        </div>
