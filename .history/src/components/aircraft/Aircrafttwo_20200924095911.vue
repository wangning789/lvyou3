      ...
      <div class="box">
        ...
        <div>
          <div v-for="(item,index) in aviation" :key="index">
            <div class="gob">
              <div style="font-size:15px;" class="bbc">{{item.airline_name}}&nbsp;{{item.flight_no}}</div>
            <div  class="bbc" id="nkjada">
                <div class="cnn">
                <div style="font-size:22px;">{{item.dep_time}}</div>
              ...
              <div  class="bbc">
                <div class="cnn">
                <div style="font-size:22px;">{{item.arr_time}}</div>
