    ...
    <div class="max">
        <div class="box">
            <div class="mox"> 
                ...
                <div class="dfa tubiao">
                   <div> <div><FormOutlined /></div><div>评论()</div></div>
                    <div><div><BranchesOutlined /></div><div>分享</div></div>
                </div>
            </div>
...
onMounted(()=>{
    ...
    data.id=route.query.id as string
      ...
      console.log(store.state.pamid)
    api.getpostwen({id:Number(data.id)||store.state.pamid}).then(res=>{
